...
const FilmScreen = (props) => {
  ...
  let {id} = match.params; // ":2"
  id = id.match(/\d+/)[0]; // "2"
  const movie = films.find((film) => film.id === parseInt(id, 10));
  const {name, genre, released, rating, scoresCount, description, director, starring} = movie;
    ...
    <React.Fragment>
          ...
          <div className="movie-card__wrap">
            <div className="movie-card__desc">
              ...
              <div className="movie-card__buttons">
                ...
                <button onClick={() => history.push(`../films/:${id}/review`)} className="btn movie-card__button">Add review</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="page-content">
        <section className="catalog catalog--like-this">
          ...
          <MovieList films={films.slice(0, 4)}/>
